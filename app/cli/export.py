...
def export_command(
    ...
    示例:
        app export --output ./export/model.tar.gz
        app export --format zip --output ./export/model.zip
        app export --format json --output ./export/domain.json
    """
    ...
    click.echo("=" * 50)
    click.echo("Customer Service Agent AI - 导出")
    click.echo("=" * 50)
